package elec332.eflux2.wire.ground;
...
import elec332.eflux2.util.EnumConnectionPlace;
...
import elec332.eflux2.wire.WireData;
...
public class GroundWire {
    ...
    private boolean addColors(int otherSize, int wireData) {
        ...
        cChange = true;
        if (wire != null) {
            wire.getWorld().neighborChanged(wire.getPos(), EFlux2.WIRE_MARKER, wire.getPos());
        }
        return true;
    }
