...
public enum EnumConnectionPlace {
    ...
    CORNER_UP { // Cornering up, within the same block
        ...
        @Override
        public Pair<BlockPos, EnumFacing> modify(World world, BlockPos myPos, GroundWire wire, EnumFacing to) {
    ...
    CORNER_DOWN { //Cornering down, other block
        ...
        public Pair<BlockPos, EnumFacing> modify(World world, BlockPos myPos, GroundWire wire, EnumFacing to) {
            ...
            if (!block.isEmpty()) {
                EnumFacing f = WireFacingHelper.getHorizontalFacingFromReal(wire.getPlacement(), to);
    ...
    @Nullable
    public abstract Pair<BlockPos, EnumFacing> modify(World world, BlockPos myPos, GroundWire wire, EnumFacing to);
    ...
    private static boolean isValid(World world, BlockPos pos, GroundWire wire, VoxelShape remFromBlock, EnumFacing to, EnumConnectionPlace caller) {
